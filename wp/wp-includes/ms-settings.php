...
/** WP_Network class */
require_once( COMMAND_ABSPATH . WPINC . '/class-wp-network.php' );

/** WP_Site class */
require_once( COMMAND_ABSPATH . WPINC . '/class-wp-site.php' );

/** Multisite loader */
require_once( COMMAND_ABSPATH . WPINC . '/ms-load.php' );

/** Default Multisite constants */
require_once( COMMAND_ABSPATH . WPINC . '/ms-default-constants.php' );
