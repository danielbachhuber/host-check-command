...
Once you've done so, you can install this package with `wp package install danielbachhuber/host-check-command`.
...
Once you’ve done a bit of searching and discovered there isn’t an open or fixed issue for your bug, please [create a new issue](https://github.com/danielbachhuber/host-check-command/issues/new) with the following:
